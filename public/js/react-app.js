...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AwesomeComponent = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AwesomeComponent = function (_React$Component) {
		...
		function AwesomeComponent(props) {
			...
			_this.style = 'mammothimg desaturate';
			return _this;
		}
		...
		_createClass(AwesomeComponent, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ onClick: this.onLike, className: 'imgdiv' },
						_react2.default.createElement('img', { src: this.props.img, className: this.state.likesCount > 0 ? 'mammothimg' : 'mammothimg desaturate' })
					)
				);
			}
		}]);
